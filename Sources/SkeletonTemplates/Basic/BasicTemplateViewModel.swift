...
struct BasicTemplateViewModel: Template {
    let fileNameSuffix = "ViewModel"
    let content =
        """
        import RxSwift
        import RxCocoa
        ...
        protocol $NAME$ViewModel {
            var viewState: Driver<$NAME$.ViewState> { get }
        }
        ...
        extension $NAME$ {
            ...
            struct ViewModel: $NAME$ViewModel {
            ...
            typealias ViewModelFactory = (ViewEvents) -> $NAME$ViewModel
        }
